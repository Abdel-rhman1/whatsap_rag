...
<body x-data="{ sidebarOpen: true }">
    ...
    >
        ...
        <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto custom-scrollbar">
            ...
            <x-nav-item href="{{ route('widget.index') }}" label="Chat Widget" icon="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" :active="request()->routeIs('widget.*')" expanded="sidebarOpen" />
